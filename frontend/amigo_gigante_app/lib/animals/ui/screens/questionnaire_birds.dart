...
class QuestionnaireBird extends StatefulWidget{
  final List<Question> questions;
  
    const QuestionnaireBird({Key key, this.questions});
    @override
    State<StatefulWidget> createState() {
      // TODO: implement createState
      return _QuestionnaireBird(questions);
    }
  
  }
  

class _QuestionnaireBird extends State<QuestionnaireBird>{
  final List<Question> questions;
  AnimalBloc animalBloc;
  int index=0;
  _QuestionnaireBird(this.questions);
                      ...
                      children: <Widget>[
                        ...
                        BlueCircularButton(text: "Terminar", onPressed: (){
                          // Navigator.push(context,MaterialPageRoute(builder: (BuildContext context )=>ResultsSpecies(title:"Resultados")));
                           Navigator.popAndPushNamed(context, '/resultsBirds');

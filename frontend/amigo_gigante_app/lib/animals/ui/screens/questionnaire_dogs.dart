...
class QuestionnaireDog extends StatefulWidget{
  final List<Question> questions;
  
    const QuestionnaireDog({Key key, this.questions});
    @override
    State<StatefulWidget> createState() {
      // TODO: implement createState
      return _QuestionnaireDog(questions);
    }
  
  }
  

class _QuestionnaireDog extends State<QuestionnaireDog>{
  final List<Question> questions;
  AnimalBloc animalBloc;
  int index=0;
  _QuestionnaireDog(this.questions);
                      ...
                      children: <Widget>[
                        ...
                        BlueCircularButton(text: "Terminar", onPressed: (){
                          // Navigator.push(context,MaterialPageRoute(builder: (BuildContext context )=>ResultsSpecies(title:"Resultados")));
                           Navigator.popAndPushNamed(context, '/resultsDogs');

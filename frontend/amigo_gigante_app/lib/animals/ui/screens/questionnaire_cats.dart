...
class QuestionnaireCat extends StatefulWidget{
  final List<Question> questions;
  
    const QuestionnaireCat({Key key, this.questions});
    @override
    State<StatefulWidget> createState() {
      // TODO: implement createState
      return _QuestionnaireCat(questions);
    }
  
  }
  

class _QuestionnaireCat extends State<QuestionnaireCat>{
  final List<Question> questions;
  AnimalBloc animalBloc;
  int index=0;
  _QuestionnaireCat(this.questions);
                      ...
                      children: <Widget>[
                        ...
                        BlueCircularButton(text: "Terminar", onPressed: (){
                          // Navigator.push(context,MaterialPageRoute(builder: (BuildContext context )=>ResultsSpecies(title:"Resultados")));
                           Navigator.popAndPushNamed(context, '/resultsCats');

...
class ViewResultsDogs extends StatelessWidget{
  final List<Animal> animals;

  const ViewResultsDogs({Key key, this.animals}) : super(key: key);
                ...
                slivers: <Widget>[
                  ...
                  SliverList(delegate: SliverChildBuilderDelegate(
                    ...
                    (BuildContext context, int index){
                      ...
                      return Container(margin: EdgeInsets.only(top:30,bottom:30),child:DogCard(dog: animals[index]));
                    },
